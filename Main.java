...
public class Main{
	...
	public Main(){
		...
		Kangaroo k4 = new Kangaroo("Ezio", 44, 1.3, "Male", "AB", 26, 39, "Riesgo moderado", dk4, 48.4, true);//editar
		KangarooZone kz3 = new KangarooZone(1, 78, 10.4, k4);//third habitat3
		Date dk3 = new Date(24, 07, 2017);//first kangaroo in habitat2
		Kangaroo k3 = new Kangaroo("Felicity", 30, 1.2, "Female", "o", 21, 31.25, "Riesgo bajo", dk3, 33, false);//first kangaroo in habitat2
		...
		Kangaroo k1 = new Kangaroo("Stone", 70, 1.4, "Male", "AB", 35, 52.5, "Riesgo moderado", dk1, 48.8, false); //first kangaroo in habitat1
		KangarooZone kz1 = new KangarooZone(2, 10, 19.2, k1); //first habitat
		Date dk2 = new Date(20, 10, 2016);//second kangaroo in habitat1
		Kangaroo k2 = new Kangaroo("Dany", 40, 1.0, "Female", "A", 40, 60, "Riesgo alto", dk2, 44, false); //second kangaroo in habitat1
		kz1.setKangaroo2(k2);
