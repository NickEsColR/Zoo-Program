...
public class Main{
	...
	public Main(){
		...
		Kangaroo k4 = new Kangaroo("Ezio", 44, 1.3, "Male", "AB", dk4, 48.4, true, null);//editar
		...
		Kangaroo k3 = new Kangaroo("Felicity", 30, 1.2, "Female", "o", dk3, 33, false, vdk3);//first kangaroo in habitat2
		...
		Kangaroo k1 = new Kangaroo("Stone", 70, 1.4, "Male", "AB", dk1, 48.8, false, vdk1); //first kangaroo in habitat1
		...
		Kangaroo k2 = new Kangaroo("Dany", 40, 1.0, "Female", "A", dk2, 44, false, vdk2); //second kangaroo in habitat1
		kz1.setKangaroo2(k2);
		...
		while (cont != 6){
			...
			switch (election){
				...
				case 4:
					...
					System.out.println("*************************************************************************");
					System.out.println("Dar nombre del animal cuyo nombre empieza por vocal ");
